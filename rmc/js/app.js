 ...
 */            (function(window, factory) {
    ...
    (() => {
        ...
        const items = document.querySelector(".js-iso-items");
        if (items) {
            ...
            let $items = document.querySelectorAll(".js-nav-filter-item");
            $items.forEach(($item => {
                $item.addEventListener("click", (() => {
                    $items.forEach((elem => elem.classList.remove("active-latest-project")));
                    let filter = $item.dataset.filter;
                    filter === "*" ? itemsGrid.arrange({
                        filter: ""
                    }) : itemsGrid.arrange({
                        filter: `[data-filter="${filter}"]`
                    });
                    $item.classList.add("active-latest-project");
                }));
            }));
        }
        class DynamicAdapt {
